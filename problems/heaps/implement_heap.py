...
Therefore, given a node at index i, its children are at indices:
 2i+1+ and  2i+2, and its parent is at index (i−1)/2. 
...
only sift up and down..
insert, getmin and popmin
